      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <span className="text-2xl font-bold tracking-tight">
                FREE<span className="text-primary-light">WORK</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-warm-gray-light text-sm">
          ...
          {/* Opening Hours */}
          <div>
            <h3 className="font-semibold text-lg mb-4">Otevírací doba</h3>
            <ul className="space-y-2 text-warm-gray-light text-sm">
        ...
        {/* Bottom bar */}
        <div className="border-t border-warm-gray/30 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
